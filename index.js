...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://library-management-uri0.onrender.com/api-docs'); // Adjust for your origin
...
const swaggerOptions = {
    definition: {
      ...
      servers: [
        {
          url: "https://library-management-uri0.onrender.com", // Server URL
